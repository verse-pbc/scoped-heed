...
use crate::{Scope, ScopedDbError, ScopedBytesCodec, utils::HeedRangeAdapter, BytesKeyIterResult};
    ...
    V: Serialize + for<'de> Deserialize<'de> + 'static,
{
    ...
    pub fn new(env: &Env, name: &str, registry: Arc<GlobalScopeRegistry>) -> Result<Self, ScopedDbError> {
    ...
    pub fn create(env: &Env, name: &str, txn: &mut RwTxn, registry: Arc<GlobalScopeRegistry>) -> Result<Self, ScopedDbError> {
