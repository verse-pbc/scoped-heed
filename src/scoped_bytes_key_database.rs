...
where
    V: Serialize + for<'de> Deserialize<'de> + 'static,
{
    /// Creates a new ScopedBytesKeyDatabase.
    ///
    ...
    ///
    /// This method creates a new ScopedBytesKeyDatabase that uses the provided
    ...
    ///
    /// ```no_run
    /// # use scoped_heed::{ScopedBytesKeyDatabase, ScopedDbError, Scope};
